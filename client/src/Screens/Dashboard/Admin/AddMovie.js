...
import CastsModal from "../../../Components/Modals/CastsModals";
    ...
    <SideBar>
      ...
      <div className="flex flex-col gap-6">
                ...
                >
                  ...
                  <div className="flex-rows mt-2 w-full gap-2">
                    <button
                      ...
                      className="w-6 h-6 flex-colo bg-gold border border-border text-subMain rounded"
                    >
                      <MdDelete />
                    </button>
                    <button
        ...
        <button
          ...
          className="bg-gold w-full flex-rows gap-6 font-medium text-white py-4 rounded"
        >
          {isLoading ? (
            "Please wait..."
          ) : (

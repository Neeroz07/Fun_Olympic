...
function MovieRates({ movie }) {
 ...
 const{register,handleSubmit,watch,formState:{errors},} =  useForm({resolver: yupResolver(ReviewValidation),});
    ...
    <div className="my-12">
      ...
      <div className="mt-10 xl:grid flex-colo grid-cols-5 gap-12 bg-dry xs:p-10 py-10 px-2 sm:p-20 rounded">
        ...
        <form onSubmit={
          ...
          <Message name="comment" register={{...register("comment")}} label="Message" placeholder="Make it short and sweet...." />
          {
          ...
          {/* submit */}
          {
           ...
           : (
            <Link to="/"
            className="bg-main border border-dashed text-subMain py-3 w-full flex-colo rounded">
